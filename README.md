# Engine Auto Stop Eliminator for SUBARU Levorg VN5 Firmware

This repository contains sources for the engine start-stop system eliminator for SUBARU Levorg VN5 firmware, based off of the CANable firwmare.
...
Simply plug in your CANable with the BOOT jumper enabled (or depress the boot button on the CANable Pro while plugging in). Next, type `make flash` and your CANable will be updated to the engine auto stop eliminator for SUBARU Levorg VN5 firwmare. Unplug/replug the device after moving the boot jumper back, and your CANable will be up and running as engine auto stop eliminator for SUBARU Levorg VN5.
